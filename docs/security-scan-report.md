...
| Public note HTML          | —        | Addressed – `generateHTML` with shared extensions; HTML sanitized with DOMPurify before `dangerouslySetInnerHTML`; only published notes shown |
