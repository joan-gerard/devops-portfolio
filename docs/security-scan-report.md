...
| Public note HTML          | —        | Addressed – `generateHTML` with shared extensions (see `tipTapExtensions.ts`); only published notes shown          |
